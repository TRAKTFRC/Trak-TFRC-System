...
#define GPS_STATE_DATA_ACQ          1
#define GPS_STATE_DATA_ACQ_EXTENDED 2
...
public:
   ...
   double lat();
   double lng();
   char *  getLatStr (char * str);
   char *  getLonStr (char * str);
...
public:
   ...
   uint8_t gps_handler_state = GPS_STATE_START;
   bool gps_done = false;
...
private:
   ...
   // mS Timer
   volatile uint32_t _ms_timer_count = 0, _ms_uart_count = 0, _print_ms_tracker = 0;
